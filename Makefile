...
fsck:		fsck.c base64enc.c base64enc.h enumerate_images.c enumerate_images.h reposet.c reposet.h rw.h threads.c threads.h
		gcc -O6 -Wall -g -o fsck -pthread fsck.c base64enc.c enumerate_images.c reposet.c threads.c `pkg-config ivykis --cflags --libs` `libgcrypt-config --cflags --libs`
